    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input
                ...
                onChange={handleInputChange}
                className="w-full border border-gray-300 p-2 rounded-md"
                disabled={!!factura.plazoDescuento}
            />
        </div>
        <div>
            <label className="block font-medium text-gray-700">
        ...
        <div>
            ...
            <input
                type="number"
                name="plazoDescuento"
                value={(factura.plazoDescuento) ?? 0}
                onChange={handleInputChange}
                className="w-full border border-gray-300 p-2 rounded-md"
                placeholder="Ingrese el plazo de descuento"
                disabled={!!factura.fechaEmision || !!factura.fechaVencimiento}
            />
        </div>
    </div>
</div>
